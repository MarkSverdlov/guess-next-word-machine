...
\begin{abstract}
    ...
    sentences. The code for this submission is located on Github\footnote{https://github.com/MarkSverdlov/guess-next-word-machine.git}.
\end{abstract}
...
trains and infers the trained model over arbitrary textual data. Finally, we executed this code over an example dataset and got some example outputs.
...
\begin{table}[!ht]
    ...
    \bottomrule
    \end{tabular}
    \caption{Completions for ``I love ''}
\end{table}
\begin{table}[!ht]
    \centering
    \begin{tabular}{cc}
    ...
    \bottomrule
    \end{tabular}
    \caption{Completions for ``This law is dis''}
\end{table}
...
\begin{table}[!ht]
    ...
    \bottomrule
    \end{tabular}
    \caption{Completions for ``Uncle Tonny went to the f''}
\end{table}
\FloatBarrier
